...
import { setIngredients, removeChosenIngredient, getChosenIngredients } from "../actions/ingredients";
...
const mapDispatchToProps = dispatch =>({
    ...
    addRecipie: (formResult) => addRecipie(dispatch, formResult),
    getChosenIngredients: () => dispatch(getChosenIngredients())
